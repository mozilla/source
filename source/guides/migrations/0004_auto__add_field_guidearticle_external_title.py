...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GuideArticle.external_title'
        db.add_column('guides_guidearticle', 'external_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GuideArticle.external_title'
        db.delete_column('guides_guidearticle', 'external_title')
    ...
    models = {
        ...
        'guides.guidearticle': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'external_title': ('django.db.models.fields.CharField', [], {'max_length': '128', 'blank': 'True'}),
