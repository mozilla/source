...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.article_js_header'
        db.add_column('articles_article', 'article_js_header',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Article.article_js_footer'
        db.add_column('articles_article', 'article_js_footer',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.article_js_header'
        db.delete_column('articles_article', 'article_js_header')

        # Deleting field 'Article.article_js_footer'
        db.delete_column('articles_article', 'article_js_footer')
    ...
    models = {
        'articles.article': {
            ...
            'article_js_footer': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'article_js_header': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
