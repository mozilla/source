...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.image_caption'
        db.add_column('articles_article', 'image_caption',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Article.image_credit'
        db.add_column('articles_article', 'image_credit',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True),
                      keep_default=False)

        # Adding field 'ArticleBlock.image_caption'
        db.add_column('articles_articleblock', 'image_caption',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'ArticleBlock.image_credit'
        db.add_column('articles_articleblock', 'image_credit',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True),
                      keep_default=False)


        # Changing field 'ArticleBlock.image_presentation'
        db.alter_column('articles_articleblock', 'image_presentation', self.gf('django.db.models.fields.CharField')(max_length=24))

    def backwards(self, orm):
        # Deleting field 'Article.image_caption'
        db.delete_column('articles_article', 'image_caption')

        # Deleting field 'Article.image_credit'
        db.delete_column('articles_article', 'image_credit')

        # Deleting field 'ArticleBlock.image_caption'
        db.delete_column('articles_articleblock', 'image_caption')

        # Deleting field 'ArticleBlock.image_credit'
        db.delete_column('articles_articleblock', 'image_credit')


        # Changing field 'ArticleBlock.image_presentation'
        db.alter_column('articles_articleblock', 'image_presentation', self.gf('django.db.models.fields.CharField')(max_length=16))
