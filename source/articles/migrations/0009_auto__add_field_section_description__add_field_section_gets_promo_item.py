...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('articles_section', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Section.gets_promo_items'
        db.add_column('articles_section', 'gets_promo_items',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Section.special_template'
        db.add_column('articles_section', 'special_template',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('articles_section', 'description')

        # Deleting field 'Section.gets_promo_items'
        db.delete_column('articles_section', 'gets_promo_items')

        # Deleting field 'Section.special_template'
        db.delete_column('articles_section', 'special_template')
    ...
    models = {
        'articles.article': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['articles.Category']", 'null': 'True'}),
