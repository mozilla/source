...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.show_in_lists'
        db.add_column('articles_article', 'show_in_lists',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.show_in_lists'
        db.delete_column('articles_article', 'show_in_lists')
