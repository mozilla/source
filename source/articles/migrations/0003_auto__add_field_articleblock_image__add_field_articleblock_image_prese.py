...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ArticleBlock.image'
        db.add_column('articles_articleblock', 'image',
                      self.gf('sorl.thumbnail.fields.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ArticleBlock.image_presentation'
        db.add_column('articles_articleblock', 'image_presentation',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=16, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ArticleBlock.image'
        db.delete_column('articles_articleblock', 'image')

        # Deleting field 'ArticleBlock.image_presentation'
        db.delete_column('articles_articleblock', 'image_presentation')
    ...
    models = {
        ...
        'articles.articleblock': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('sorl.thumbnail.fields.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'image_presentation': ('django.db.models.fields.CharField', [], {'max_length': '16', 'blank': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
