...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.disable_auto_linebreaks'
        db.add_column('articles_article', 'disable_auto_linebreaks',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.disable_auto_linebreaks'
        db.delete_column('articles_article', 'disable_auto_linebreaks')
