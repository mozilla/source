...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('articles_article', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(default=10, to=orm['articles.Category']))

    def backwards(self, orm):

        # Changing field 'Article.category'
        db.alter_column('articles_article', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['articles.Category'], null=True))
