...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Organization.github_repos_num'
        db.add_column('people_organization', 'github_repos_num',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Organization.github_gists_num'
        db.add_column('people_organization', 'github_gists_num',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Organization.github_repos_num'
        db.delete_column('people_organization', 'github_repos_num')

        # Deleting field 'Organization.github_gists_num'
        db.delete_column('people_organization', 'github_gists_num')
