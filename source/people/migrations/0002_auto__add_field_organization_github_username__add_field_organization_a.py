...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Organization.github_username'
        db.add_column('people_organization', 'github_username',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True),
                      keep_default=False)

        # Adding field 'Organization.address'
        db.add_column('people_organization', 'address',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Organization.city'
        db.add_column('people_organization', 'city',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)

        # Adding field 'Organization.state'
        db.add_column('people_organization', 'state',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True),
                      keep_default=False)

        # Adding field 'Organization.country'
        db.add_column('people_organization', 'country',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Organization.github_username'
        db.delete_column('people_organization', 'github_username')

        # Deleting field 'Organization.address'
        db.delete_column('people_organization', 'address')

        # Deleting field 'Organization.city'
        db.delete_column('people_organization', 'city')

        # Deleting field 'Organization.state'
        db.delete_column('people_organization', 'state')

        # Deleting field 'Organization.country'
        db.delete_column('people_organization', 'country')
