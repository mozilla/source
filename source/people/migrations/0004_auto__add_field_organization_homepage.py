...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Organization.homepage'
        db.add_column('people_organization', 'homepage',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Organization.homepage'
        db.delete_column('people_organization', 'homepage')
