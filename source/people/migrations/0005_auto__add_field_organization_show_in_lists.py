...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Organization.show_in_lists'
        db.add_column('people_organization', 'show_in_lists',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Organization.show_in_lists'
        db.delete_column('people_organization', 'show_in_lists')
