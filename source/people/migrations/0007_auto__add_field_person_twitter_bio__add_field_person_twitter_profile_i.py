...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('people_person', 'twitter_bio',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Person.twitter_profile_image_url'
        db.add_column('people_person', 'twitter_profile_image_url',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('people_person', 'twitter_bio')

        # Deleting field 'Person.twitter_profile_image_url'
        db.delete_column('people_person', 'twitter_profile_image_url')
