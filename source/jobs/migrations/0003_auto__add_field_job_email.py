...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column('jobs_job', 'email')
    ...
    models = {
        'jobs.job': {
            ...
            'listing_end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 12, 0, 0)'}),
            'listing_start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 13, 0, 0)'}),
